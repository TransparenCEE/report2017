<section id="section-event-4" data-anchor="event-4" class="section event-section">
  <div class="content-column">
    <h2 class="slide-title">
      <span class="title-text">DataFest Tbilisi</span>
    ...
    <div class="event-images top-bottom">
      ...
      <div class="event-image-2">
        <img src="images/datafest-2.jpg" alt="">
        <div class="event-image-link">
          <?php include ("moduls/photos-datafest-2017.php"); ?>
